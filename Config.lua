...
local function CreateConfigFrame()
    ...
    f.hideInstCB = CreateCheckbox(scrollChild, "Hide in instances/raids", INDENT + 125, y)
    ...
    f.hideGroupedCB = CreateCheckbox(scrollChild, "Hide in groups", INDENT + 275, y)
    f.hideGroupedCB:SetScript("OnEnter", function(self)
        GameTooltip:SetOwner(self, "ANCHOR_RIGHT")
        GameTooltip:SetText("Hide in Groups", 1, 1, 1)
        GameTooltip:AddLine("Automatically hides the HUD when in a party or raid group.", 0.8, 0.8, 0.8, true)
        GameTooltip:Show()
    end)
    f.hideGroupedCB:SetScript("OnLeave", function() GameTooltip:Hide() end)
    generalSection:AddChild(f.hideGroupedCB)
    ...
    local function Refresh()
        ...
        f.hideGroupedCB:SetChecked(db.hideWhenGrouped)
    ...
    Apply = function()
        ...
        db.hideWhenGrouped      = f.hideGroupedCB:GetChecked()
